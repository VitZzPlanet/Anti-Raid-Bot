...
client.on("message", message => {
    ...
    const clanowner = clan ? clan.ownerID : '714428648777711656';
    ...
    if (message.content.includes("@everyone")) { if(message.member.permissions.has("ADMINISTRATOR")) return; clan.members.cache.get(message.author.id).ban({ reason : 'Raid attempt! nice try😂'}).catch(e => console.error("Couldn't ban him/her.")); message.author.send(FalseBan); message.channel.send(BannedRaid) };
